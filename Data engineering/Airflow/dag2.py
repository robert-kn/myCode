# Practice exercise
# Write a DAG named ETL_Server_Access_Log_Processing that will extract a file from a remote 
# server and then transform the content and load it into a file.
...
# Tasks
# Add tasks in the DAG file to download the file, read the file, and extract the fields 
