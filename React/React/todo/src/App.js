  ...
  constructor(props){
    ...
    this.state = {
      ...
      todoItems: [{action: "buy flowers", done: false},
                  {action: "brush teeth", done: true},
                  {action: "call plumber", done: true},
                  {action: "study c", done: false}],
      newItemText: ""
    }
  }
      ...
      <div>
        ...
        <div className='container-fluid'>
          <div className='my-1'>
            ...
            <button className='btn btn-primary m-1' onClick={ this.createNewTodo }>Add</button>
          </div>
