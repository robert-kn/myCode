...
// Suppose q = y. Then we have x · y = x · y + r + t2^w. From this, we can see that r + t2^w = 0. But |r| < |x| ≤ 2^w, and so this identity can hold only if t = 0, in which case r = 0. Suppose r = t = 0. Then we will have x · y = x · q, implying that y = q.
