...
M: The value of the significand. This should be a number of the form x or x/y, where x is an integer and y is an integral power of 2. Examples include 0, 67/64, and 12/56.
...
As an example, to represent the number 7/8, we would have s = 0, M=7/4 and E = -1. Our number would therefore have an exponent field of 01110 (decimal value 15 - 1 = 14) and a significand field of 1100000000, giving a hex representation 3B00. The numerical value is 0.875. You need not fill in entries marked —.
