; The purpose of this program is to request two integers (between 0 and 9) from the user,
; add them, and display the result (which must also be between 0 and 9) in the console
; panel.
