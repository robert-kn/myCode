...
the numbers 1.2,3.4, and 5.6 and they are stored in variables d1, d2, and d3, the program should rotate their values one place right, so that d1, d2, and d3 become 5.6, 1.2, and 3.4,
respectively. */
